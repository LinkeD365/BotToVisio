...
XDocument partXML)
   ...
   XDocument packagePart, string elementType)
    ...
    string attributeName, string attributeValue)
        ...
        private static void CreateNewPage(string name, int topicCount)
        {
            // Need to check first to see whether the part exists already.
            var packageLocation = new Uri(Uri.EscapeUriString($"/visio/pages/flowPage{topicCount}.xml"), UriKind.Relative);
